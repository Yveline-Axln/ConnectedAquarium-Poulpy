...
BLEUnsignedIntCharacteristic pH("07460004-baca-44ee-aa79-c4d892ae71d0", BLERead | BLEWrite | BLENotify); 
...
void setup() {
  ...
  temperatureC.setValue(0);
  turbidityAnalogVoltage.setValue(0);
...
void updateWaterLevel() {
   State = lvl.getState();
        ...
        if (State == HIGH) {
          //switchCharacteristic.setValue(State);
